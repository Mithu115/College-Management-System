						...
						<section class="mt-3">
															...
															<div class="col-md-6">
																<div class="form-group">
																	...
																	<select class="browser-default custom-select" name="course_code" required="">
																		...
																		<?php
																			$query="select distinct(course_code) from course_subjects";
																			$run=mysqli_query($con,$query);
							...
							<table class="w-100 table-elements mb-5 table-three-tr" cellpadding="10">
								...
								while($row=mysqli_fetch_array($run)) {
									...
									echo	"<td width='170'><a class='btn btn-primary' href=display-teacher.php?teacher_id=".$row['teacher_id']."><i class='fa fa-eye aria-hidden'='true'></i></a> 
										<a class='btn btn-info' href=teacher-personal-information.php?teacher_id=".$row['teacher_id']."><i class='fa fa-pencil-square' aria-hidden='true'></i></a>
										<a class='btn btn-danger' href=delete-function.php?teacher_id=".$row['teacher_id']."><i class='fa fa-trash' aria-hidden='true'></i></a></td>";
									echo "</tr>";
								}
								?>
							</table>				
