							...
							<table class="w-100 table-elements mb-5 table-three-tr text-center" cellpadding="10">
								...
								while($row=mysqli_fetch_array($run)) {
									...
									<tr>
										...
										<td width='180'> 
											<?php 
												echo "<a class='btn btn-primary' href=display-student.php?roll_no=".$row['roll_no']."><i class='fa fa-eye aria-hidden'='true'></i></a> 
												 <a class='btn btn-info' href=student-personal-information.php?roll_no=".$row['roll_no']."><i class='fa fa-pencil-square' aria-hidden='true'></i>
</a>
												<a class='btn btn-danger' href=delete-function.php?roll_no=".$row['roll_no']."><i class='fa fa-trash' aria-hidden='true'></i>
</a>"
											?>
										</td>
									</tr>
